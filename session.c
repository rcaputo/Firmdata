...
void session_event_deliver_adcSampleReady(uint8_t channel, uint8_t timeStamp, uint8_t data) {
...
void session_subscription_timer_cb(volatile struct timer *p) {
	...
	adc_take_sample(subscription->pin, subscription->channel);
}
